...
import 'download_items.dart';
import 'downloading_list_item.dart';

class TaskTwoPage extends StatefulWidget with WidgetsBindingObserver {
...
class _TaskTwoPageState extends State<TaskTwoPage> {
  ...
  Future<void> _prepareSaveDir() async {
    ...
    ;
    _localPath = externalStorageDirPath!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Task-2 File download"),
      ),
      body: Builder(
        builder: (context) {
          if (!_showContent) {
